module "route53" {
  ...
  private_cidr_blocks = data.terraform_remote_state.dev_network.outputs.private_cidr
  public_cidr_blocks  = data.terraform_remote_state.dev_network.outputs.public_cidr
  ...
  environment         = data.terraform_remote_state.dev_network.outputs.environment
